...
abstract class VideoPlayerInstanceApi {
  ...
  ///
  /// LOCAL ADDITION — not in upstream video_player_android. See the note at
  /// the top of VideoPlayer.java for why it exists.
  ///
  /// This is not setVolume(0). Volume silences the output; the decoder still
  /// runs, holding a hardware AAC instance and an AudioTrack for a player
  /// nobody can hear. Disabling the track type stops the work.
